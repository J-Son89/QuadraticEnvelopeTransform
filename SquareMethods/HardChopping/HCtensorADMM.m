%%%
% This file runs the ADMM algorithm using the square case of the Hard Chopping with tensors and no misfit weights as discussed in paper
%
% {params} 
...
%
%%% 
function [X,y,differenceNorm,iterationsTaken,converged] = HCtensorADMM(f,K,rho,iterations)
