%%%
% This file runs the ADMM algorithm using the square case of the /hard Chopping with tensors and misfit weights as discussed in paper
%
% {params} 
...
%
%%% 
function [X,y,differenceNorm,iterationsTaken,converged] = HCallADMM(f,K,rho,iterations)
