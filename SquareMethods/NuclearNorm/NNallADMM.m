%%%
% This file runs the ADMM algorithm using the square case of the Nuclear Norm with tensors and misfit weights as discussed in paper
%
% {params} 
...
%
%%% 
function [X,y,differenceNorm,iterationsTaken,converged] = NNallADMM(f,rho,iterations, lambda)
