%%%
% This file runs the ADMM algorithm using the square case of the Quadratic Envelope with tensors and no misfit weights as discussed in paper
%
% {params} 
...
%
%%% 
function [X,y,differenceNorm,iterationsTaken,converged] = QEtensorADMM(f,K,rho,iterations,gama)
